...
(function(window) {
    ...
    var support = {
        ...
        // the mall element
        p2dview = document.querySelector('.p2dview'),
        p3dview = document.querySelector('.p3dview'),
    ...
    p3dview.addEventListener('click', function(ev) {
        ev.preventDefault();
        classie.remove(mallLevelsEl, 'p2dview');
        classie.add(mallLevelsEl, 'p3dview');
    ...
    /*  var mc = new Hammer(mall);

      // listen to events...
      mc.on("panleft panright tap press", function(ev) {
          //console.log(mall.textContent = ev.type + " gesture detected.");
          var panleft = panleft + 8;
          console.log(ev.type + " gesture detected.");
          mall.style.transform = 'translateY(' + panleft + 'vmin)';
          classie.toggle(mall, ev.type);
          /* if (ev.type = "panleft") {

               var i = i + 8;
               mall.style.transform = 'translateY(' + i + 'vmin)';
           }*/
    // mall.style.
    //    });
